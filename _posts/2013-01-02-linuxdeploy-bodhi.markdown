...
comments: true
categories: linuxdeploy install bodhi
---

Linux Deploy поддерживает запуск дистрибутива <a href="http://www.bodhilinux.com/">Bodhi Linux</a> под Android.

![linuxdeploy](/images/linuxdeploy-bodhilinux-e17.png "Bodhi Linux и E17"){: .center}
