...
comments: true
categories: linuxdeploy install raspbian
---
...
![linuxdeploy](/images/linuxdeploy-raspbian-mate.png "Rapsbian MATE"){: .center}

### Инструкция

- Скачать образ с <a href="http://www.raspbian.org/PiscesMATEImages">официального сайта</a>: <a href="http://archive.raspbian.org/images/rpi_pisces_mate_r2.zip">rpi_pisces_mate_r2.zip</a>
